...
for i in range(50):
    ...
    content_list = soup.find_all('td', class_='num')
    ...
    for post in content_list:
        content_element = post.find('span')  # 게시글 제목을 담고 있는 <a> 태그를 선택합니다.
        content = content_element.get_text(strip=True)  # 게시글 제목을 가져옵니다.
        #print(title)
