...
def scrape_job_data(job_num):
    data = []
    #delay = 0.3
    for i in range(10):
        url = f"https://www.inven.co.kr/board/lostark/{job_num}?p="+str(i)
        ...
        for post, content_num in zip(post_list, content_list_num):
            ...
            content_url = f"https://www.inven.co.kr/board/lostark/{job_num}/{num}"
            print(num)
...
def scrape_and_save_data():
    ...
    for job, job_num in key_value_dict.items():
        data = scrape_job_data(job_num)
